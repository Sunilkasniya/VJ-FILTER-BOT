...
API_ID = int(environ.get('API_ID', '26166421'))
API_HASH = environ.get('API_HASH', '7d061d8146ced58434d19295d7684ba3')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1076866236').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002114971216').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://liyamryland:hjof4iEYFHf7q8Ii@cluster0.sbp3gz9.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002009663860'))
...
URL = "https://sk-bot-3s33.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://sk-bot-3s33.onrender.com/".format(FQDN, PORT)
